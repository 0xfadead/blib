 ...
 */
time_test time_test_start(nullable const char* caption);
 ...
 */
void time_test_end(nonnullable time_test *test);
 ...
 */
time_testrun_template time_testrun_new(nullable const char* caption, unsigned long testnumber, nonnullable time_test (*testfunc)(unsigned int index, void* data), nullable void* data, unsigned int features);
 ...
 */
time_testrun_results time_testrun_run(nonnullable const time_testrun_template* template);
 ...
 */
void time_testrun_print(nonnullable const time_testrun_results* results);
